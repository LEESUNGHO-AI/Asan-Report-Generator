...
const BMS_MAP = {
  ...
  "모바일 전자시민증 플랫폼 / 인프라":2,"데이터기반 AI 융복합 서비스 구축":13,
  "디지털 노마드접수/운영 및 거래관리":12,"국제표준 디지털링크 공유 플랫폼":14,
...
const NAMES = {1:"유무선 네트워크 구축",2:"모바일 전자시민증(ECC)",3:"이노베이션 센터 구축",
  4:"디지털 OASIS SPOT",5:"SDDC Platform 구축",6:"AI 통합관제 플랫폼",
  7:"디지털 OASIS 정보관리",8:"DRT 수요응답형 교통",9:"감리용역",
  10:"스마트폴&디스플레이",11:"메타버스 플랫폼",12:"디지털 노마드(NOP)",13:"AI 융복합 서비스",14:"디지털링크 플랫폼"};
